			...
			<form action={formAction} className="space-y-2" noValidate>
				<div className="flex gap-2">
					...
					<button
						type="submit"
						disabled={pending}
						className="shrink-0 rounded-md bg-accent px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-accent-hover disabled:cursor-not-allowed disabled:opacity-60"
					>
	...
	return (
		<form action={formAction} className="space-y-4" noValidate>
			...
			<button
				type="submit"
				disabled={pending}
				className="block w-full rounded-md bg-accent px-5 py-2.5 text-center text-sm font-medium text-white transition-colors hover:bg-accent-hover disabled:cursor-not-allowed disabled:opacity-60 sm:inline-block sm:w-auto"
			>
